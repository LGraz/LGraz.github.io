...
Using the notation from [Wikipedia](https://en.wikipedia.org/wiki/Coefficient_of_determination):
...
Consider fold 2:
$$ SS_{\text{res}} = 0.5^2 + 0.499^2 = 0.499 $$
...
- Use the (R)MSE
- Use the MAE
- “pseudo R-squared”: 1 - mse / Var(y) (c.f. the R-implementation of [randomForest](https://www.rdocumentation.org/packages/randomForest/versions/4.7-1.1/topics/randomForest))
