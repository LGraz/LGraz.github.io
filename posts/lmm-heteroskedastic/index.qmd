...
# Abstract
- `glmmTMB` can model heteroscedastic data via the `dispformula` argument (c.f. section @sec-sim-dat-vis-w-disp). 
- Type I error rate is slightly inflated. Regardless if modeled on homo-/heteroscedastic data accounting/ignoring heteroscedasticity with lmer and glmmTMB
